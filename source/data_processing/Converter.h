...
public:
    ...
    // correct the data
    std::vector<IntegrationVector> light_time_correction(std::map<std::string, Observatory>, std::vector< Observation>, std::vector<EarthRotation>*, std::vector<HubbleData>, std::vector<IntegrationVector>);
    BarycentricCoord n_abs(BarycentricCoord);
    std::vector<IntegrationVector> gravitational_deflection(std::map<std::string, Observatory>, std::vector< Observation>, std::vector<EarthRotation>*, std::vector<IntegrationVector>, std::vector<HubbleData>, std::vector<IntegrationVector> earth_position);
    std::vector<IntegrationVector> aberration(std::map<std::string, Observatory>, std::vector< Observation>, std::vector<EarthRotation>*, std::vector<IntegrationVector>, std::vector<HubbleData>, std::vector<IntegrationVector> earth_position);
};
