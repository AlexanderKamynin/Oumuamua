...
public:
	...
	void light_correct(std::vector<Observation>* observation, std::vector<IntegrationVector>* model_orbit, std::vector<ModelMeasure>* model_measures, std::vector<IntegrationVector>* sun_info, std::vector<IntegrationVector>* earth_info, std::vector<IntegrationVector>* earth_velocity_info);
	...
	void aberration(BarycentricCoord* observatory_position, BarycentricCoord* sun, Velocity* earth_velocity);
